  ...
  if (state.success) {
    return (
      <div className="bg-moss/10 border border-moss/30 rounded-2xl p-8 text-center">
        ...
        <h3 className="font-heading text-xl font-semibold text-moss dark:text-moss-light mb-2">Request Sent!</h3>
    ...
    <form action={action} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            type="text"
            required
            className="w-full border border-sand-dark bg-card rounded-xl px-4 py-3 text-charcoal placeholder-charcoal-light/50 focus:outline-none focus:ring-2 focus:ring-moss"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <select
            id="sessionType"
            name="sessionType"
            className="w-full border border-sand-dark bg-card rounded-xl px-4 py-3 text-charcoal focus:outline-none focus:ring-2 focus:ring-moss"
          >
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows={5}
          className="w-full border border-sand-dark bg-card rounded-xl px-4 py-3 text-charcoal placeholder-charcoal-light/50 focus:outline-none focus:ring-2 focus:ring-moss resize-none"
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-full bg-moss text-cream font-semibold py-3 rounded-full hover:bg-moss-light disabled:opacity-60 transition-colors"
      >
