  ...
  return (
    <>
      ...
      <section className="bg-moss py-14 px-4 sm:px-6 lg:px-8 text-center">
        <p className="text-sand text-sm font-semibold uppercase tracking-widest mb-3">Say hello</p>
        <h1 className="font-heading text-4xl sm:text-5xl font-bold text-sand mb-4">
          Book a Session
        </h1>
        <p className="text-sand/80 max-w-md mx-auto">
          Tell me what you&apos;re picturing — portraits, family, pets, events, or something else entirely.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          {/* Form */}
          <div className="lg:col-span-3 bg-white border border-sand-dark rounded-2xl p-6 sm:p-8 shadow-sm">
