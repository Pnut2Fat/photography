...
export const services: Service[] = [
  {
    ...
    description: "My specialty. A relaxed shoot with your pets, farm animals, or critters, wherever they're most comfortable. Price is negotiable, so just ask.",
    startingPrice: 15,
  ...
  },
  {
    ...
    description: "New to portraits, so I'm keeping the rate low while I build experience. Price is negotiable, so just ask.",
    startingPrice: 20,
